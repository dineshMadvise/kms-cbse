...
class GetCertificateListRepo extends BaseService {
  Future<GetCertificateListResModel> getCertificateList() async {
    ...
    //   return null;
    // }
    final result = GetCertificateListResModel.fromJson(response);
    log("GetCertificateList  REPO : => $response");
    return result;
  }
}
