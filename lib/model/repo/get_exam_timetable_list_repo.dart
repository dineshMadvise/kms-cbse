...
class GetExamTimeTableListRepo extends BaseService {
  Future<GetExamTimetableListResModel> getExamTimeTableList() async {
    UserData data = ConstUtils.getUserData();
    StudentData studentData = ConstUtils.getStudentData();

    Map<String, dynamic> body = {
      "action": "getexamtimetablelist",
    ...
    //   return null;
    // }
    final result = GetExamTimetableListResModel.fromJson(response);
    log("GetExamTimetableListResModel  REPO : => $response");
    return result;
  }
}
