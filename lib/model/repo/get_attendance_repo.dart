...
class GetAttendanceRepo extends BaseService {
  Future<GetAttendanceResModel> getAttendance(DateTime date) async {
    ...
    //   return null;
    // }
    final result = GetAttendanceResModel.fromJson(response);
    log("GetAttendanceResModel  REPO : => $response");
    return result;
  }
}
