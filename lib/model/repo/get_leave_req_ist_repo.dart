...
class GetLeaveReqListRepo extends BaseService {
  Future<GetLeaveReqListResModel> getLeaveReqList() async {
    UserData data = ConstUtils.getUserData();
    StudentData studentData = ConstUtils.getStudentData();

    Map<String, dynamic> body = {
      "action": "getLeaveReqList",
    ...
    //   return null;
    // }
    final result = GetLeaveReqListResModel.fromJson(response);
    log("GetLeaveReqListResModel  REPO : => $response");
    return result;
  }
}
