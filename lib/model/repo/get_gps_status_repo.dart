...
class GetGpsStatusRepo extends BaseService {
  Future<GetGpsStatusResModel> getGpsStatus() async {
    ...
    //   return null;
    // }
    final result = GetGpsStatusResModel.fromJson(response);
    log("GetGpsStatusResModel  REPO : => $response");
    return result;
  }
}
