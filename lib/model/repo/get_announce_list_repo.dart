...
class GetAnnounceListRepo extends BaseService {
  Future<GetAnnounceListResModel> getAnnounceList() async {
    ...
    //   return null;
    // }
    final result = GetAnnounceListResModel.fromJson(response);
    log("GetAnnounceListResModel  REPO : => $response");
    return result;
  }
}
