...
class GetLeaveApprovalListRepo extends BaseService {
  Future<GetLeaveApprovalListResModel> getLeaveApprovalList() async {
    UserData data = ConstUtils.getUserData();
    StudentData studentData = ConstUtils.getStudentData();

    Map<String, dynamic> body = {
      "action": "getLeaveApprovalList",
    ...
    //   return null;
    // }
    final result = GetLeaveApprovalListResModel.fromJson(response);
    log("GetLeaveApprovalListResModel  REPO : => $response");
    return result;
  }
}
