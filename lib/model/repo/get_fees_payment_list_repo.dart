...
class GetFeesPaymentListRepo extends BaseService {
  Future<GetFeesPaymentListResModel> getFeesPaymentList() async {
    UserData data = ConstUtils.getUserData();
    StudentData studentData = ConstUtils.getStudentData();

    Map<String, dynamic> body = {
      "action": "getFeesPaymentList",
    ...
    //   return null;
    // }
    final result = GetFeesPaymentListResModel.fromJson(response);
    log("GetFeesPaymentListResModel  REPO : => $response");
    return result;
  }
}
