...
class GetGalleryRepo extends BaseService {
  Future<GetGalleryResModel> getGallery() async {
    ...
    //   return null;
    // }
    final result = GetGalleryResModel.fromJson(response);
    log("GetGalleryResModel  REPO : => $response");
    return result;
  }
}
